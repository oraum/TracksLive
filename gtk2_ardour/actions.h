...
namespace ActionManager {
    ...
    extern std::vector<Glib::RefPtr<Gtk::Action> > record_and_playback_restricted_actions;
    ...
    extern std::vector<Glib::RefPtr<Gtk::Action> > region_exists_sensitive_actions;
    extern std::vector<Glib::RefPtr<Gtk::Action> > region_or_time_selection_sensitive_actions;
