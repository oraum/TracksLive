...
vector<RefPtr<Gtk::Action> > ActionManager::record_and_playback_restricted_actions;
vector<RefPtr<Gtk::Action> > ActionManager::region_list_selection_sensitive_actions;
vector<RefPtr<Gtk::Action> > ActionManager::region_exists_sensitive_actions;
vector<RefPtr<Gtk::Action> > ActionManager::region_or_time_selection_sensitive_actions;
