...
{
    _ignore_lls_change = false;
    _location_list_selection = 0;
}
...
void
TimeSelection::set_location_list_selection (LocationListSelection* lls)
{
    if (!_ignore_lls_change) {
        _location_list_selection = lls;
    }
}

bool
TimeSelection::update_current_selection_is_allowed ()
{
    return _location_list_selection && _location_list_selection->allow_to_show_update_current_selection_menu_on_canvas ();
}

LocationListSelection*
TimeSelection::get_location_list_selection ()
{
    return _location_list_selection;
}

void
TimeSelection::set_ignore_lls_change (bool yn)
{
    _ignore_lls_change = yn;
}
