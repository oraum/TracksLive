...
class PublicEditor : public Gtk::Window, public PBD::StatefulDestructible, public Gtkmm2ext::VisibilityTracker, public WavesUI {
  public:
    ...
    /** Restore session routes amount to default */
    virtual void restore_session_to_default () = 0;
	...
	*/
    ...
    virtual void restore_selection (LocationListSelection*) = 0;

	virtual void transition_to_rolling (bool fwd) = 0;
    virtual void update_edit_selection_menu () = 0;
    ...
    virtual MasterBusUI* master_bus_ui () = 0;
    ...
    virtual void externally_remove_marker (ARDOUR::Location*) = 0;
    ...
    virtual bool check_all_tracks_are_record_safe () = 0;
	...
	virtual bool canvas_range_marker_handle_event (GdkEvent* event, ArdourCanvas::Item*, bool leftside) = 0;
