...
PBD::Signal0<void> ArdourMeter::ResetAllPeakDisplays;
PBD::Signal1<void,ARDOUR::Route*> ArdourMeter::ResetRoutePeakDisplays;
PBD::Signal1<void,ARDOUR::RouteGroup*> ArdourMeter::ResetGroupPeakDisplays;
PBD::Signal0<void> ArdourMeter::RedrawMetrics;
