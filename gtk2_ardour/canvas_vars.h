...
CANVAS_VARIABLE(canvasvar_LocationSelected, "location selected")
CANVAS_VARIABLE(canvasvar_LocationOutline, "location outline")
CANVAS_VARIABLE(canvasvar_LocationHandle, "location handle")
CANVAS_VARIABLE(canvasvar_LoopRangeMarkerActive, "loop range marker: active")
CANVAS_VARIABLE(canvasvar_LoopRangeMarkerInactive, "loop range marker: inactive")
...
CANVAS_VARIABLE(canvasvar_MeterHighlightBackgroundBot, "meter highlight background: bottom")
CANVAS_VARIABLE(canvasvar_MeterHighlightBackgroundTop, "meter highlight background: top")
...
CANVAS_VARIABLE(canvasvar_SkipDragBarRect, "skip drag bar rect")
...
CANVAS_VARIABLE(canvasvar_RulerDividerTop, "ruler divider top")
CANVAS_VARIABLE(canvasvar_RulerDividerBottom, "ruler divider bottom")
...
CANVAS_VARIABLE(canvasvar_SkipBar, "skip bar")
...
CLOCK_VARS(MarkerListClock, "marker list clock")
