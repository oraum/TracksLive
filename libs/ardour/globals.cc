...
static ARDOUR::FPU_Optimization __current_fpu_optimization = NONE;
...
setup_hardware_optimization (bool try_optimization)
{
	...
	if (try_optimization) {
		...
		if (fpu.has_avx()) {
            ...
            __current_fpu_optimization = AVX;
            ...
            __current_fpu_optimization = SSE;
		...
		if (sysVersion >= 0x00001040) { // Tiger at least
            ...
            __current_fpu_optimization = APPLE_VECLIB;
		}
#endif
	...
	if (generic_mix_functions) {
        ...
        __current_fpu_optimization = NONE;
	}
...
ARDOUR::FPU_Optimization
ARDOUR::get_fpu_optimization ()
{
    return __current_fpu_optimization;
}
