...
class LIBARDOUR_API Session : public PBD::StatefulDestructible, public PBD::ScopedConnectionList, public SessionEventManager
{
  public:
	...
	*/
    ...
    /* If (order_hint == default_order_hint) tracks will be added to the end*/
    static const int32_t default_order_hint;
    ...
    void   set_slave_state (bool);
    bool   get_slave_state () const;
  ...
  private:
	...
	*/
    ...
    /** keep start frame to make sure we will start the transport
     if currently sitting on a stop marker */
    framepos_t _stop_marker_sentinel;
	...
	void update_marks (Location* loc, bool update_stops = false);
	void consolidate_skips (Location*);
	void sync_locations_to_skips ();
	void _sync_locations_to_skips ();
    void sync_locations_to_stops ();
    void _sync_locations_to_stops ();
    ...
    bool _ignore_stop_marker_updates;
  ...
  private:
	...
	SourceMap sources;
    std::set<std::string> all_removed_sources_path;
  ...
  private:
	...
	*/
    ...
    gint get_freewheel_timeout_enabled () const;
    bool stop_freewheel ();
    
    sigc::connection _freewheel_timeout_function_connection;
    gint _freewheel_timeout_enabled;
    mutable Glib::Threads::Mutex freewheel_lock;
};
