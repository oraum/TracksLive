...
CONFIG_VARIABLE (uint32_t, freewheel_timeout_ms, "freewheel-timeout-ms", 0)
...
#ifdef __APPLE__
CONFIG_VARIABLE_SPECIAL (std::string, default_session_parent_dir, "default-session-parent-dir", Glib::get_home_dir() + "/Music", poor_mans_glob)
#elif defined (PLATFORM_WINDOWS)
CONFIG_VARIABLE_SPECIAL (std::string, default_session_parent_dir, "default-session-parent-dir", Glib::get_home_dir() + "\\Documents", poor_mans_glob)
#else
CONFIG_VARIABLE_SPECIAL (std::string, default_session_parent_dir, "default-session-parent-dir", Glib::get_home_dir() , poor_mans_glob)
#endif
...
CONFIG_VARIABLE (uint32_t, max_freewheel_timeout_ms, "max-freewheel-timeout", 5000)
