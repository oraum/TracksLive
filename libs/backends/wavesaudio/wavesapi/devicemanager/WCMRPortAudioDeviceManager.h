...
public:
	...
	WCMRPortAudioDevice (WCMRPortAudioDeviceManager *pManager, unsigned int  deviceID, const std::string& name, bool useMultiThreading = true, bool bNoCopy = false);///<Constructor
...
protected:
	...
	void updateDeviceInfo(bool callerIsWaiting = false, bool updateSR = true, bool updateBuffersChannels = true);
	...
	unsigned int m_CallbacksReceived;
